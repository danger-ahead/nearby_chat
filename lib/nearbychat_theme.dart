...
class NearbyChatTheme {
  ...
  static Color primaryHeading(context) {
    return Theme.of(context).brightness == Brightness.dark
        ? NearbyChatTheme.primaryColor
        : Colors.black;
  }

  static Color boxBg(context) {
    return Theme.of(context).brightness == Brightness.dark
        ? NearbyChatTheme.bgCardDark
        : NearbyChatTheme.bgCard;
  }

  static Color boxShadow(context) {
    return Theme.of(context).brightness == Brightness.dark
        ? NearbyChatTheme.bgCardDark
        : NearbyChatTheme.grey;
  }
  ...
  static ThemeData themeData(context) {
    return ThemeData(
      ...
      colorScheme: ThemeData().colorScheme.copyWith(
            brightness: Theme.of(context).brightness,
            primary: NearbyChatTheme.secondaryColor,
          ),
    );
  }
  ...
  static const OutlineInputBorder primaryDarkOutlineBorder = OutlineInputBorder(
    ...
    borderSide: BorderSide(color: NearbyChatTheme.primaryColorDark),
  );

  static const OutlineInputBorder redOutlineBorder = OutlineInputBorder(
    borderRadius: BorderRadius.zero,
    borderSide: BorderSide(color: NearbyChatTheme.red),
  );

  static const InputDecoration textFieldDecoration = InputDecoration(
    contentPadding: EdgeInsets.all(8),
    focusedBorder: NearbyChatTheme.primaryDarkOutlineBorder,
    enabledBorder: NearbyChatTheme.primaryDarkOutlineBorder,
    errorBorder: NearbyChatTheme.redOutlineBorder,
    focusedErrorBorder: NearbyChatTheme.redOutlineBorder,
  );
}
